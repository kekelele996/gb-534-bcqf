...
import type { AnalysisState, DeviationAnalysis, PhaseReviewDecisionRequest } from '../types/deviation-analysis'
...
export const submitPhaseReview = (id: number, request: PhaseReviewDecisionRequest) =>
  api<DeviationAnalysis>(`/deviation-analyses/${id}/phase-reviews`, json('POST', request))
